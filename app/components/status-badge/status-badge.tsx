...
export function StatusBadge({ status }: Props): JSX.Element {
  ...
  return (
    <p
      className={clsx(
        'status-color inline-flex items-baseline justify-center gap-2 rounded bg-status-transparent px-4 py-3 font-bold capitalize text-status before:bg-status',
